          ...
          <div className="container-main">
            <div className="grid lg:grid-cols-[1fr_400px] gap-12 lg:gap-20">
              ...
              <div className="order-1 lg:order-2 space-y-6">
                ...
                {/* Social Links */}
                <a
                  href="https://www.linkedin.com/in/rajesh-kumar-87a18585"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-6 rounded-2xl bg-surface-100/50 border border-surface-300/30 hover:border-brand-cyan-500/30 transition-all duration-300 group flex items-center gap-4"
                >
                  <div className="w-12 h-12 rounded-xl bg-[#0077B5]/10 border border-[#0077B5]/30 flex items-center justify-center group-hover:bg-[#0077B5]/20 transition-colors flex-shrink-0">
                  ...
                  <div>
                    <p className="text-sm text-neutral-500 mb-0.5">LinkedIn</p>
                    <p className="font-medium group-hover:text-brand-cyan-500 transition-colors">Rajesh Kumar</p>
                  </div>
                </a>
              </div>
            </div>
